...
let vehicle = prompt('Name a mode of transportation');
// TODO: A variable named "vehiclePart" for a part of the vehicle you just named.
let vehiclePart = prompt('Name a part of the vehicle you just chose');
// TODO: A variable named "parking" for a location where you park the vehicle you just named.
let parking = prompt('Where did you park the vehicle you chose?');
// TODO: A variable named "precious" for a precious object.
let precious = prompt('Name an object that is precious to you');
...
let adjective2 = prompt('Name another word used to describe something');
// TODO: A variable named "adjective3" for a word used to describe something.
let adjective3 = prompt('One more word used to describe something');
...
let familyMember = prompt('Choose a family member');
